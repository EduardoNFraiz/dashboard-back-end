...
### 4.2 Ontologia Empresarial (EO)
Diagrama baseado na especificação UFO para representação de organizações e equipes.
...
classDiagram
    ...
    TeamMembership o-- OrganizationalRole : "is to play"
    TeamMembership o-- TeamMember : "allocates"
    TeamMembership o-- Team : "done for"
    
    Team "1" *-- "1..*" TeamPurpose : "has"
    Project "1" -- "0..*" ProjectTeam : "has"
    Organization "1" -- "0..*" OrganizationalTeam : "has"
```
